...
#import "ZEKSystemInfo.h"

@implementation ZEKSystemInfo

DEF_SINGLETON( ZEKSystemInfo )
...
+ (BOOL)isPhone35
{
    ...
    {
        return [ZEKSystemInfo isScreenSize:CGSizeMake(320, 480)];
    }
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
+ (BOOL)isPhoneRetina35
{
    ...
    {
        return [ZEKSystemInfo isScreenSize:CGSizeMake(640, 960)];
    }
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
+ (BOOL)isPhoneRetina4
{
    ...
    {
        return [ZEKSystemInfo isScreenSize:CGSizeMake(640, 1136)];
    }
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [ZEKSystemInfo isScreenSize:CGSizeMake(768, 1024)];
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
}
...
{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return [ZEKSystemInfo isScreenSize:CGSizeMake(1536, 2048)];
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
    return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
}
